      ...
      <div className="row text-center align-items-center">
        <div className="col-lg-6 col-md-12 p-3">
          <div className="map card m-auto embed-responsive embed-responsive-16by9">
             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.746728283041!2d79.41620827465363!3d13.115224787213446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52b3f54f3d5d6d%3A0x53e758e1dd22e463!2sJoy%20fashion!5e0!3m2!1sen!2sin!4v1725095686108!5m2!1sen!2sin"
        ...
        <div className="col-lg-6 col-md-12">
            <div className="card p-5">
                <h2 className='footer-title mb-3'><b>Contact Us</b></h2>
                  <p className='mb-2'><b>Address:</b> Sholinghur,Tamilnadu.</p>
                  <p className='mb-2'><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at 1234567890</a></p>
                  <p className='mb-4'><b>Hours:</b>  From 8 a.m To 9 p.m</p>
